    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        void SetupColorGrading(CommandBuffer cmd, ref RenderingData renderingData, Material material)
        {
            ...
            else
            {
                ...
                //XRP_FEATURE
                //Adding Type of XD_ACES tonemapper keyword
                    case TonemappingMode.XD_ACES: material.EnableKeyword(ShaderKeywordStrings.TonemapXDACES); break;
                //XRP_FEATURE Type End
